...
public class FxChip extends Label {
    ...
    private final ObjectProperty<ChipVariant> variant = new SimpleObjectProperty<>(this, "variant", ChipVariant.DEFAULT);
     ...
     */
    public FxChip(String text, ChipVariant variant) {
        this(text);
        setVariant(variant);
    }
    ...
    public ObjectProperty<ChipVariant> variantProperty() { return variant; }

    /** Returns the current variant. */
    public ChipVariant getVariant() { return variant.get(); }

    /** Sets the variant. */
    public void setVariant(ChipVariant v) { variant.set(v); }
     ...
     *   <li>variant — {@link ChipVariant#DEFAULT}</li>
    ...
    public static class Builder extends FxComponentBuilder<FxChip, Builder> {
        ...
        public Builder variant(ChipVariant variant) {
